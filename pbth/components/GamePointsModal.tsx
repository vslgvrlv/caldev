...
// Выбор пойнта — вход в рефлексию (#89). Игра со счётом 4:3 это семь пойнтов,
...
//
// Пойнты создаёт сервер из счёта игры. Из счёта известно только СКОЛЬКО побед,
        ...
        <div className="p-5 space-y-3">
          ...
          {!isLoading && data && !data.expected && (
            <p className="text-sm text-pb-subtext">
              Укажи счёт игры (например 4:3) — из него появятся пойнты, за которые заполняется рефлексия.
            </p>
          )}
